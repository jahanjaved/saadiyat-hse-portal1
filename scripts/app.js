...
function detailChartOptions(){
  return {responsive:true,maintainAspectRatio:false,animation:false,plugins:{legend:{display:false},labelPlugin:{}},scales:{x:{ticks:{color:'#bfd2e9',font:{size:10},maxRotation:75,minRotation:75,autoSkip:false},grid:{display:false}},y:{beginAtZero:true,max:5,ticks:{color:'#bfd2e9',stepSize:1},grid:{color:'rgba(191,210,233,.08)'}}}};
}
